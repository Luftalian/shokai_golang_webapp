...
import (
	...
	"github.com/Luftalian/shokai_golang_webapp/testutil/fixture"
...
func TestJWTer_GetToken(t *testing.T) {
	...
	want, err := jwt.NewBuilder().
					...
					Issuer(`github.com/Luftalian/shokai_golang_webapp`).
...
func (f FixedTomorrowClocker) Now() time.Time {
...
func TestJWTer_GetToken_NG(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"expired": {
			// return future timestamp for expired timestamp
